...
Yes, you need this. Build the movement patterns that keep you injury-free and make the heavy stuff possible. Nobody's impressed by your deadlift if you're doing it wrong.

**Focus:** Anatomical Adaptation

**RPE Range:** 5-6

**Sessions:** 2x/week (A + B rotation)
...
★ MAIN 1: Squat Pattern │ 3 sets │ 90s rest │ RPE 5-6
  A1 Split Squat (bodyweight) ─ [same reps/sets]
     → https://vimeo.com/111129796
  A2 Incline Push-Up (hands elevated) ─ [same reps/sets]
     → https://vimeo.com/111147882

★ MAIN 2: Core + Carry │ 3 sets │ 90s rest │ RPE 5-6
  B1 Dead Bug ─ [same reps/sets]
     → https://vimeo.com/111109110
  B2 Farmer Carry (light-moderate) ─ [same reps/sets]
     → https://vimeo.com/112074204
...
★ MAIN 1: Squat Pattern │ 3 sets │ 90s rest │ RPE 5-6
  A1 Goblet Split Squat (light DB/KB) ─ [same reps/sets]
     → https://vimeo.com/111128363
  A2 Push-Up (floor) ─ [same reps/sets]
     → https://vimeo.com/111473394

★ MAIN 2: Core + Carry │ 3 sets │ 90s rest │ RPE 5-6
  B1 Dead Bug ─ [same reps/sets]
     → https://vimeo.com/111109110
  B2 Farmer Carry (heavier than W1-2) ─ [same reps/sets]
     → https://vimeo.com/112074204
...
★ MAIN 1: Squat Pattern │ 3 sets │ 90s rest │ RPE 6
  ...
  A2 Push-Up + Shoulder Tap ─ [same reps/sets]
     → https://vimeo.com/111473395

★ MAIN 2: Core + Carry │ 3 sets │ 90s rest │ RPE 6
  B1 Dead Bug (add light weight) ─ [same reps/sets]
     → https://vimeo.com/111109110
  B2 Suitcase Carry (single side) ─ [same reps/sets]
...
★ PREP (5 min) │ 2 rounds │ 60s rest
  • Glute Bridge (double leg) ─ [same reps/sets]
     → https://vimeo.com/111033887
  • Band Pull-Apart ─ [same reps/sets]
...
★ MAIN 1: Hinge Pattern │ 3 sets │ 90s rest │ RPE 5-6
  ...
  A2 Band Row (bent-over) ─ [same reps/sets]
     → https://vimeo.com/111255280

★ MAIN 2: Glute + Pull │ 3 sets │ 90s rest │ RPE 5-6
  B1 Single-Leg Glute Bridge ─ [same reps/sets]
     → https://vimeo.com/111546505
  B2 Incline Row (hands on chair/table) ─ 10 reps

★ CORE (8 min) │ 2 rounds │ 60s rest
  C1 Side Plank (knees bent OK) ─ [same reps/sets]
     → https://vimeo.com/111522888
  C2 Bird Dog ─ [same reps/sets]
     → https://vimeo.com/111048715
  C3 Pallof Press (light band) ─ [same reps/sets]
...
★ MAIN 1: Hinge Pattern │ 3 sets │ 90s rest │ RPE 5-6
  A1 KB/DB RDL (light) ─ [same reps/sets]
     → https://vimeo.com/111121974
  A2 Inverted Row (body at 45°) ─ [same reps/sets]
     → https://vimeo.com/111241988

★ MAIN 2: Glute + Pull │ 3 sets │ 90s rest │ RPE 5-6
  B1 Single-Leg Glute Bridge (foot elevated) ─ [same reps/sets]
     → https://vimeo.com/111546505
  B2 TRX Row or Band Row (steeper angle) ─ [same reps/sets]
     → https://vimeo.com/111255280

★ CORE (8 min) │ 2 rounds │ 60s rest
  C1 Side Plank (straight legs) ─ [same reps/sets]
     → https://vimeo.com/111522888
  C2 Bird Dog ─ [same reps/sets]
     → https://vimeo.com/111048715
  C3 Pallof Press ─ [same reps/sets]
     → https://vimeo.com/111469204
...
★ PREP (5 min) │ 2 rounds │ 60s rest
  • Glute Bridge (banded) ─ [same reps/sets]
     → https://vimeo.com/111033887
  • Band Pull-Apart ─ [same reps/sets]
     → https://vimeo.com/111033315
...
★ MAIN 1: Hinge Pattern │ 3 sets │ 90s rest │ RPE 6
  A1 KB/DB RDL (moderate load) ─ [same reps/sets]
     → https://vimeo.com/111121974
  A2 Single-Arm DB Row ─ [same reps/sets]
     → https://vimeo.com/111523514

★ MAIN 2: Glute + Anti-Rotation │ 3 sets │ 90s rest │ RPE 6
  B1 Single-Leg Glute Bridge (banded) ─ [same reps/sets]
     → https://vimeo.com/111546505
  B2 Pallof Press (walk-out) ─ [same reps/sets]
     → https://vimeo.com/111469204

★ CORE (8 min) │ 2 rounds │ 60s rest
  C1 Side Plank w/ Hip Dip ─ [same reps/sets]
     → https://vimeo.com/111522888
  C2 Bird Dog (opposite reach) ─ [same reps/sets]
     → https://vimeo.com/111048715
  C3 Dead Bug ─ [same reps/sets]
     → https://vimeo.com/111109110
...
This is where strength actually happens. Progressive overload, compound movements, real weight. Your legs already know how to spin circles — teach them to produce force.
...
★ MAIN 1: Squat Pattern │ 4 sets │ 90s rest │ RPE 7-8
  A1 Goblet Squat ─ [same reps/sets]
     → https://vimeo.com/111129796
  A2 Push-Up + Shoulder Tap ─ [same reps/sets]
     → https://vimeo.com/111473395

★ MAIN 2: Single-Leg Strength │ 4 sets │ 90s rest │ RPE 7-8
  B1 Bulgarian Split Squat (or Goblet Squat) ─ [same reps/sets]
...
★ CORE/CARRY (10 min) │ 3 rounds │ 60s rest
  C1 Dead Bug (weighted) ─ [same reps/sets]
     → https://vimeo.com/111109110
  C2 Suitcase Carry ─ [same reps/sets]
     → https://vimeo.com/111545001
...
★ PREP (5 min) │ 2 rounds │ 60s rest
  • MiniBand Lateral Walks ─ 10/side
  • Box Jump (low, stick landing) ─ [same reps/sets]
...
★ MAIN 1: Squat Pattern │ 4 sets │ 2-3 min rest │ RPE 8-9
  ...
  A2 DB Bench Press ─ [same reps/sets]
     → https://vimeo.com/111032510

★ MAIN 2: Single-Leg Strength │ 4 sets │ 2-3 min rest │ RPE 8-9
  B1 Bulgarian Split Squat (heavy) or Goblet Squat ─ [same reps/sets]
     → https://vimeo.com/111043982
  B2 DB Floor Press (heavy) ─ [same reps/sets]
     → https://vimeo.com/111043103

★ CORE/CARRY (8 min) │ 2 rounds │ 90s rest
  C1 Weighted Dead Bug ─ [same reps/sets]
     → https://vimeo.com/111109110
  C2 Heavy Farmer Carry ─ [same reps/sets]
     → https://vimeo.com/112074204
  C3 Plank (brace hard) ─ [same reps/sets]
...
★ MAIN 1: Hinge Pattern │ 4 sets │ 90s rest │ RPE 7-8
  A1 Single-Leg RDL (or Conventional RDL) ─ [same reps/sets]
     → https://vimeo.com/111545574
  A2 Bent-Over DB Row ─ [same reps/sets]
     → https://vimeo.com/111048714

★ MAIN 2: Pull + Hinge │ 4 sets │ 90s rest │ RPE 7-8
  B1 KB/DB Deadlift ─ [same reps/sets]
...
★ CORE (10 min) │ 3 rounds │ 60s rest
  C1 Pallof Press (hold 5 sec) ─ [same reps/sets]
     → https://vimeo.com/111469204
  C2 Side Plank ─ [same reps/sets]
     → https://vimeo.com/111522888
  C3 Band Chop ─ [same reps/sets]
...
★ MAIN 2: Single-Leg + Row │ 4 sets │ 2-3 min rest │ RPE 8-9
  B1 Single-Leg RDL (heavy) or Conventional RDL ─ [same reps/sets]
     → https://vimeo.com/111545574
  B2 Heavy DB Row (3-point) ─ 6/side
     → https://www.youtube.com/watch?v=pYcpY20QaE8

★ CORE (8 min) │ 2 rounds │ 90s rest
  C1 Pallof Press (heavy band) ─ [same reps/sets]
     → https://vimeo.com/111469204
  C2 Side Plank ─ [same reps/sets]
     → https://vimeo.com/111522888
...
Strength you can't access quickly is useless at hour six. Convert your gym gains into explosive power that actually shows up when you need to punch over a climb or close a gap.
...
★ POWER PREP (5 min) │ 2 rounds │ 60s rest
  • Box Jump (stick landing) ─ [same reps/sets]
     → https://vimeo.com/111032509
...
★ MAIN 1: Explosive Squat │ 4 sets │ 2 min rest │ Max Intent
  A1 Jump Squat (bodyweight) ─ [same reps/sets]
     → https://vimeo.com/111473749
  A2 Plyo Push-Up (hands leave ground) ─ [same reps/sets]
     → https://vimeo.com/111126228

★ MAIN 2: Loaded Power │ 4 sets │ 2 min rest │ RPE 7
  B1 Goblet Squat (moderate, FAST up) ─ [same reps/sets]
     → https://vimeo.com/111129796
  B2 Med Ball Chest Pass or Explosive Push-Up ─ [same reps/sets]
     → https://vimeo.com/111126228
...
★ POWER PREP (5 min) │ 2 rounds │ 60s rest
  • Squat Jump (low box) ─ [same reps/sets]
     → https://vimeo.com/111473749
  • Push-Up (explosive, not plyometric) ─ 5 reps

★ MAIN 1: Sport-Specific │ 3 sets │ 2 min rest │ Quality Focus
  A1 Single-Leg Squat to Box (or Goblet Squat) ─ [same reps/sets]
     → https://vimeo.com/111550275
  A2 Clapping Push-Up or Fast Push-Up ─ [same reps/sets]
     → https://vimeo.com/111126228

★ MAIN 2: Reduced Volume │ 3 sets │ 2 min rest │ RPE 6-7
  B1 Split Squat Jump (or Jump Squat) ─ [same reps/sets]
     → https://vimeo.com/111473749
  B2 Med Ball Push or Explosive Push-Up ─ [same reps/sets]
     → https://vimeo.com/111126228

★ CORE (5 min) │ 2 rounds │ 45s rest
  C1 Dead Bug (fast) ─ [same reps/sets]
     → https://vimeo.com/111109110
...
Two weeks out isn't the time to PR your squat. Minimum effective dose to hold your adaptations while your legs freshen up for race day. Touch it, don't crush it.
...
★ ACTIVATION (5 min) │ 1 round
  • Box Jump or Squat Jump (light) ─ [same reps/sets]
     → https://vimeo.com/111032509
  • Push-Up ─ 5 reps
  • Lateral Lunge ─ 5/side

★ MAIN (10 min) │ 2 sets │ 2 min rest │ Stay Sharp
  A1 Goblet Squat (light) ─ [same reps/sets]
     → https://vimeo.com/111129796
  A2 Push-Up ─ [same reps/sets]
     → https://vimeo.com/111473394
  A3 Jump Squat ─ [same reps/sets]
     → https://vimeo.com/111473749

★ CORE (5 min) │ 1-2 rounds
  C1 Plank ─ [same reps/sets]
     → https://vimeo.com/111471004
  C2 Dead Bug ─ [same reps/sets]
     → https://vimeo.com/111109110
...
★ MAIN 1: Ballistic Hinge │ 4 sets │ 2 min rest │ Max Intent
  A1 KB Swing (2-hand) ─ 12 reps
     → https://www.youtube.com/watch?v=sSESeQAir2M
  A2 Explosive Inverted Row or Band Pull ─ [same reps/sets]
...
★ MAIN 2: Power Hinge │ 4 sets │ 2 min rest │ RPE 7
  B1 KB Swing to Goblet Catch (or heavy swing) ─ [same reps/sets]
...
★ CORE (8 min) │ 2 rounds │ 60s rest
  C1 Med Ball Rotational Throw or Russian Twist ─ 6/side
     → Throw: https://www.youtube.com/watch?v=YRiUvhz2lag
     → Twist: https://www.youtube.com/watch?v=wkD8rjkodUI
  C2 Side Plank w/ Hip Drop ─ [same reps/sets]
     → https://vimeo.com/111522888
  C3 Pallof Press ─ [same reps/sets]
     → https://vimeo.com/111469204
...
★ MAIN 1: Cycling-Specific │ 3 sets │ 2 min rest │ Quality Focus
  A1 Single-Leg DL to Hop (or Broad Jump) ─ [same reps/sets]
     → https://vimeo.com/111545575
  A2 Band Pull-Apart (explosive) ─ [same reps/sets]
     → https://vimeo.com/111033315
...
★ CORE (5 min) │ 2 rounds │ 45s rest
  C1 Bird Dog (hold 3 sec) ─ [same reps/sets]
     → https://vimeo.com/111048715
  C2 Side Plank ─ [same reps/sets]
     → https://vimeo.com/111522888
...
★ MAIN (10 min) │ 2 sets │ 2 min rest │ Stay Sharp
  ...
  A2 Inverted Row or Pull-Up ─ 5 reps
     → Inverted: https://www.youtube.com/watch?v=GdyhjXlxE-U
     → Pull-Up: https://www.youtube.com/watch?v=eGo4IYlbE5g
  A3 Single-Leg RDL (light) ─ [same reps/sets]
     → https://vimeo.com/111545574

★ CORE (5 min) │ 1-2 rounds
  C1 Side Plank ─ [same reps/sets]
     → https://vimeo.com/111522888
  C2 Bird Dog ─ [same reps/sets]
     → https://vimeo.com/111048715
  C3 Ab Wheel or Weighted Dead Bug ─ 6 reps
