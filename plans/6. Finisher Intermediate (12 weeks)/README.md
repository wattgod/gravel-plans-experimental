# FINISHER INTERMEDIATE - SOLID FINISH PLAN (12 weeks)
...
**Target Athlete:** Some endurance background, wants efficient training, solid race finish  
...
- **20% Hard:** Z4-Z5 (100-115% FTP) - truly hard efforts
...
- **Build Period (Weeks 5-8):**
  ...
  - **Rhythm Intervals** introduced (Weeks 6, 7):
    - Pattern: 2 min Z3 (self-selected cadence) + 1 min Z4 (high cadence 100+ rpm) x 4, continuous
...
1. **Load template:**
   ```
   Load: current/plans/6. Finisher Intermediate (12 weeks)/template.json
...
Once complete (all 12 weeks), this template can be used like FINISHER BEGINNER:
- Load template.json
